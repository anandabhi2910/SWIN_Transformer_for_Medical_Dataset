...
"""### Train on MedMNIST data

We train the model on MedMNIST data. Here, we only train the model
...
"""Let's display the final results of the training on MedMNIST data."""
